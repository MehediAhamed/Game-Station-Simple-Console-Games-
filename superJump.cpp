...
int playSJ()
{
    ...
    while (repeat == 'y')
    {
        ...
        scrnRow[0] = (rand() % 4 ) + 13;        //used for determining the height of the bars
        scrnRow[1] = (rand() % 4 ) + 13;        //used for determining the height of the bars
        scrnRow[2] = (rand() % 6 ) + 13;        //used for placing the coin
